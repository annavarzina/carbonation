...
#%%
nn = '00_ccD12'
results = fn.load_obj(root_dir+'\\results\\output\\13_validation\\' + nn + '\\' + nn +'_results')
...
print(sorted(a))
#a = np.array([23.827999999943057, 59.48366666627328, 109.03900000105914, 172.1486666698208,
