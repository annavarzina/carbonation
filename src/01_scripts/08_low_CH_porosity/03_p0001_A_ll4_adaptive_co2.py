...
scale = 50
init_porosCH = 0.1
nn='01_p01_A_ll4_100s_pco2_ps0005'
#fn.make_output_dir(root_dir+'\\results\\output\\simulations\\')
path = root_dir+'\\results\\output\\08_low_porosity\\' + nn + '\\'
...
#%% PLOT
fn.plot_fields(carb_rt, names=['calcite', 'portlandite', 'poros', 'Ca', 'C'],fsize=(15,1))
'''
...
#fn.plot_points(results, names=['calcite', 'portlandite'])
'''\