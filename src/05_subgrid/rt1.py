...
class CarbonationRT(PhrqcReactiveTransport):
    ...
    def update_neighbour_solution(self, result, n_int, n_ch, m_ch, m_cc, m_cc_i, poros_m):
        #global ncell
        #ncell = ncell + 1
        ncell = 123456
        modify_str = []
        ...
        modify_str.append('%i %.20e' %( ncell, (1-poros_m) ))
        modify_str.append('%i %.20e' %( n_ch, (poros_m) ))
