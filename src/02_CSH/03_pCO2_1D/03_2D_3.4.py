...
domain.nodetype[:, 0:cr+1] = ct.Type.LIQUID
...
phrqc_input = {'c_bc':{'type':'pco2', 'value': 3.4}, # 0.1% CO2
...
if(True):
    ...
    fn.plot_fields(csh, names=['calcite', 'Ca', 'C', 'Si', 'poros'],fsize=(15,1))
...
if(True):
    ...
    print('tau %s' %str(np.array(csh.fluid.C.tau[1,:])))