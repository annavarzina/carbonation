...
settings = {'precipitation': 'interface', # 'interface'/'all'/'mineral' nodes
            ...
            'diffusivity':{'border': D, ##diffusivity at border
                           'CH': ('const', 1e-15), # fixed diffusivity in CH node 'archie'/'const'/'inverse'
                           'CC': ('inverse', 1e-9), # fixed diffusivity in CC node 'archie'/'const'/'inverse'
                           'CSH': ('const', 1e-9), # fixed diffusivity in CSH node 'archie'/'const'/'inverse'
                           }, 
