# -*- coding: utf-8 -*-
'''
Compare the results for different pores and crystal sizes (PS and CS)
'''
#%% MODULES
...
names = np.array(['02_co3_p0005', '02_c05_p0005', '02_c07_p0005',
                  '01_co3_p001', '01_c05_p001', '01_c07_p001',
                  '03_co3_p005', '03_c05_p005', '03_c07_p005' ])
label = np.array(['CS 0.3; PS 0.005', 'CS 0.5; PS 0.005', 'CS 0.7; PS 0.005',
                  'CS 0.3; PS 0.01', 'CS 0.5; PS 0.01', 'CS 0.7; PS 0.01',
                  'CS 0.3; PS 0.05', 'CS 0.5; PS 0.05', 'CS 0.7; PS 0.05'])
linetype = np.array(['-', '--', '-.',':', '-', '--', '-.',':','-', '--', '-.',':'])
