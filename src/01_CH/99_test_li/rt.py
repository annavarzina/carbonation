...
import phrqc 
from phrqc import CarbonationPhrqc
...
class CarbonationRT(PhrqcReactiveTransport):
    ...
    def update_source(self):        
        ...
        print (ss.keys())
        print ("after reaction self.phrqc.selected_out()['poros'][1,:]",self.phrqc.selected_output()['poros'][1,:])        
        print ("after reaction self.phrqc.selected_out()['Ca'][1,:]",self.phrqc.selected_output()['Ca'][1,:])
        print ("after reaction self.phrqc.selected_out()['CH'][1,:]",self.phrqc.selected_output()['portlandite'][1,:])
        print ("after reaction self.phrqc.selected_out()['C'][1,:]",self.phrqc.selected_output()['C'][1,:])
        print ("after reaction self.phrqc.selected_out()['CC'][1,:]",self.phrqc.selected_output()['calcite'][1,:])        
        print ("+++++++++++++++++++++++++++++++++++++++++")
        ...
        print ("at last self.phrqc.selected_out()['Ca'][1,:]",self.phrqc.selected_output()['Ca'][1,:])
        print ("at last self.phrqc.selected_out()['CH'][1,:]",self.phrqc.selected_output()['portlandite'][1,:])
        print ("at last self.phrqc.selected_out()['C'][1,:]",self.phrqc.selected_output()['C'][1,:])
        print ("at last self.phrqc.selected_out()['CC'][1,:]",self.phrqc.selected_output()['calcite'][1,:])
